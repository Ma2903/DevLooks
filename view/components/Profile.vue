...
function confirmAccountDeletion() {
  Swal.fire({
    ...
    html: `
      <p>Esta ação é permanente e não pode ser desfeita.<br>
      Todos os seus dados, incluindo perfil, avatares e histórico de compras, serão apagados.</p>
      <p class="mt-4 font-bold text-red-400">Digite <b>DELETAR</b> para confirmar:</p>
      <input id="swal-input" class="swal2-input" placeholder="Digite DELETAR">
    `,
    icon: 'error',
