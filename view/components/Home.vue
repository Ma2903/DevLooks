<template>
    <div class="bg-gray-900 min-h-screen font-mono text-gray-200">
      ...
      <section class="bg-gradient-to-r from-purple-800 to-black text-white text-center py-16 relative">
        <!-- Efeito de código/terminal no fundo -->
        ...
        <div class="relative z-10 container mx-auto px-6">
          <h1 class="text-5xl font-semibold mb-4 text-purple-400"><i class="fas fa-code mr-2"></i>Bem-vindo à Loja de Avatares</h1>
          <p class="text-lg mb-8">Personalize seu avatar exclusivo para GitHub e Discord. Dê um toque geek ao seu perfil!</p>
          <router-link to="/create-avatar">
            <button class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-6 rounded-full shadow-lg transition duration-300 ease-in-out transform hover:scale-105">
